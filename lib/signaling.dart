...
class Signaling {
  ...
  // screen share
  Future<void> screenShare(RTCVideoRenderer localVideo) async {
    _initForegroundTask();
  ...
  startForegroundService() async {
    await FlutterForegroundTask.startService(notificationTitle: "Ongoing screen share", notificationText: "Tap to return to the app");
    return true;
  }
  switchStream(MediaStream stream){
    peerConnection?.senders.then((senders) {
